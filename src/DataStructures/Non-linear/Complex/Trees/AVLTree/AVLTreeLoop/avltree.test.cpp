...
class AVLTreeLoopTest : public ::testing::Test {
protected:
    AVLTreeLoopTest() = default;
...
// GCC: "undefined reference" if variables defined inside AVLTreeLoopTest
const test_data_count AVLTreeLoopTest::array_values_elements_count;

std::ostream& operator<<(std::ostream& os, const AVLTreeLoopTest::ObjectA &obj) {
    return os << obj.get();
}
...
using object_type = AVLTreeLoopTest::ObjectA;
...
TEST_F(AVLTreeLoopTest, Insert) {
    std::cout << "TEST_F(AVLTreeLoopTest, Insert) start" << std::endl;
    AVLTreeLoop<test_data_type> avltree{};
    ...
    std::cout << "TEST_F(AVLTreeLoopTest, Insert) end" << std::endl;
}

TEST_F(AVLTreeLoopTest, InsertObject) {
    std::cout << "TEST_F(AVLTreeLoopTest, InsertObject) start" << std::endl;
    ...
    AVLTreeLoop<object_type> avltree{};
    ...
    std::cout << "TEST_F(AVLTreeLoopTest, InsertObject) end" << std::endl;
}

TEST_F(AVLTreeLoopTest, InsertPointers) {
    std::cout << "TEST_F(AVLTreeLoopTest, InsertPointers) start" << std::endl;
    ...
    AVLTreeLoop<store_smart_ptr_type> avltree{};
    ...
    ASSERT_TRUE(avltree.verifyCorrectness(objects_array_result)) << "AVL tree stores objects data incorrectly!";
    std::cout << "TEST_F(AVLTreeLoopTest, InsertPointers) end" << std::endl;
}

TEST_F(AVLTreeLoopTest, Delete) {
    std::cout << "TEST_F(AVLTreeLoopTest, Delete) start" << std::endl;
    AVLTreeLoop<object_type> avltreeObj{};
    std::vector<store_smart_ptr_type> objects_array_result(array_values_elements_count);
    ...
    AVLTreeLoop<test_data_type> avltree{array_values};
...
R----50(h: 4)
   ...
   R----60(h: 3)
    ...
    std::cout << "TEST_F(AVLTreeLoopTest, Delete) end" << std::endl;
}

TEST_F(AVLTreeLoopTest, Search) {
    std::cout << "TEST_F(AVLTreeLoopTest, Search) start" << std::endl;
    AVLTreeLoop<test_data_type> avltree{};
    // Search in empty structure.
    ASSERT_FALSE(avltree.search(31));
    avltree = AVLTreeLoop<test_data_type>{array_values};
    ...
    std::cout << "TEST_F(AVLTreeLoopTest, Search) end" << std::endl;
}

TEST_F(AVLTreeLoopTest, FailedVerify) {
    std::cout << "TEST_F(AVLTreeLoopTest, Search) start" << std::endl;
    AVLTreeLoop<test_data_type> avltree{};
    ...
    ASSERT_TRUE(avltree.verifyCorrectness(std::vector<test_data_type>{31, 13}));
    std::cout << "TEST_F(AVLTreeLoopTest, Search) end" << std::endl;
}